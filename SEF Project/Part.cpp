...
* PROGRAMMER    : Che Ping chien
* FIRST VERSION : 2025-07-21
* DESCRIPTION   : This program manages the part information 
*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
//this is for testing u can delete it
int main(void) {
	...
	while (1) {
		...
		case 4:
			...
			break;
		case 5:
			loadfromfile("parts.db", parts, &size);
			printf("Loaded successfully.\n");
			break;
		case 6:
			SaveToFile("parts.db", parts, &size);
